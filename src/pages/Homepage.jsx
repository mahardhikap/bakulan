            ...
            <div className="flex flex-wrap justify-center items-center gap-5">
              {post.length !== 0
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="text-center mt-3">
                          <button className="p-1 bg-green-200 rounded-md font-semibold w-full" onClick={() => setCount(count + 1)}>
                            Add to cart
                          </button>
                        </div>
                      </div>
                ...
                : data?.map((item, index) => {
                    return (
                      <div
                        className="w-40 h-60 bg-white rounded-md p-2 cursor-pointer"
                        key={index}
                      >
                        <Link to={`/detail/${item.id}`}>
                          <div className="flex justify-center items-center">
                        ...
                        <div className="text-center mt-3">
                          <button
                            className="p-1 bg-green-200 rounded-md font-semibold w-full"
